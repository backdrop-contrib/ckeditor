    ...
    init: function( editor )
    {
      ...
      editor.addCommand( 'IMCEWindow', {
        exec : function () {
          ...
          editor.popup(Backdrop.settings.basePath + 'index.php?q=imce\x26app=ckeditor|sendto@ckeditor_setFile|&CKEditorFuncNum=' + editor._.filebrowserFnIMCE, width, height);
        }
      });
